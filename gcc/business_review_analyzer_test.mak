...
ifeq "$(CFG)" "Debug"
OUTDIR=Debug
OUTFILE=$(OUTDIR)/business_review_analyzer_test.exe
CFG_INC=
CFG_LIB=$(OUTDIR)/business_review_analyzer.a 
CFG_OBJ=
...
# Build dependencies
deps:
	@(cd .;$(MAKE) -f business_review_analyzer.mak CFG=$(CFG))
...
cleanall: clean
	@(cd .;$(MAKE) -f business_review_analyzer.mak cleanall CFG=$(CFG))
endif
